...
function MatrixCanvas() {
  ...
  useEffect(() => {
    ...
    const chars = "アイウエオカキクケコ01ABCDEF∑∆Ω₿ΞETHBTC$%#@!01";
    const draw = () => {
    ...
    <div className="auth-wrapper">
      ...
      <div className="auth-box">
        <div className="auth-header">
          ...
          <p className="auth-subtitle">Register a new operator profile</p>
        </div>
        {error && <p className="auth-error">{error}</p>}
        <form className="auth-form" onSubmit={handleSubmit}>
          <div className="input-group">
            <label className="input-label">Operator Handle</label>
            <input className="auth-input" type="text" placeholder="satoshi_zero"
